...
- Recordings are due by 5:00 p.m. Eastern on the Tuesday before the next class. Keep the Google Drive coding videos folder URL, filename convention and platform-specific recording instructions in `coursebook/recording-and-submission.qmd`; weekly pages should link there rather than copy the URL.
