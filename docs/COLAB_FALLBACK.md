...
4. Run the first setup cell. It clones the public repository into the temporary Colab runtime and moves into the course directory, so accompanying data can be found.
