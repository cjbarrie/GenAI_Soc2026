...
**Chapter anchor:** *AI and Research Methods*, §10.5
...
4. trace a question through tool request, local search return, bounded claim and source record;
...
Planned: a deliberately short-horizon agent chooses one supplied search tool, receives a source record and drafts one bounded claim. Python saves the tool arguments, return, source and claim together.

## Weekly completion task

Planned: change one query and submit a narrated screen recording tracing question, tool call, source record and claim while identifying where error could enter. Upload it through the [recording and submission guide](https://cjbarrie.github.io/GenAI_Soc2026/recording-and-submission.html) by 5:00 p.m. Eastern on the Tuesday before the next class.
